...
Figure.2 showed the linear regression line and corresponding 95% confidence interval, the slope is positive: 573.0106366 (p.value = 2.097083710^{-11}), we then concluded that there is relationship between day and the total activity, this participant became more and more active over time.
